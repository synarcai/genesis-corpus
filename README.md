...
| | |
|---|---|
| **164 worlds of shows + 213 of prose** | declared in `datasets/GENESIS-MANIFEST.json`; 71 prose worlds are public-domain books on the shelf (`shelf/`, contract `declarations/SHELF.md`) |
| **29 languages** | one pack each in `tools/langpacks/`, zero engine edits |
| **121 courts + 84 instruments** | every line re-executed by a court; the corpus as a whole measured by judgeability, reproducibility, manifest, shelf, band, library, concept reach, mutation catch |
| **0** | false or blind lines among ~348 000 judged |
