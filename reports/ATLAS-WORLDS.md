...
- **`soundarticle`** (84 строк; declared, declared_table_only)  
...
- **`tzone`** (82 строк; recompute, whole_only, exact_only)  
...
- **`numline`** (82 строк; recompute, whole_only, exact_only)  
...
- **`angle`** (74 строк; recompute, whole_only, exact_only)  
...
- **`leap`** (72 строк; recompute, whole_only, exact_only)  
...
- **`homo`** (62 строк; recompute, whole_only, exact_only)  
...
- **`direct`** (30 строк; recompute, whole_only, exact_only)  
