# УКАЗАТЕЛЬ МИРОВ ПОКАЗА — 305 миров, 439014 строк
...
- **`personplace`** (282 строк; declared, declared_table_only)  
  **МЕСТО ЛИЦА В ГЛАГОЛЕ** — ВОСЕМЬ ПЛАСТОВ ОТВЕРГАЮТ «Я + ОН-ФОРМУ» И НИ ОДИН НЕ ГОВОРИТ, ГДЕ В СЛОВЕ ЛИЦО. Замер 13.09 по пластам грузинского, арабского, амхарского, греческого, персидского, тамильского, хинди и шведского: отказы «¬ მე წერს», «¬ أنا تكتب», …
...
- **`huobj`** (260 строк; declared, declared_table_only)  
  **ВЕНГЕРСКОЕ ОБЪЕКТНОЕ СПРЯЖЕНИЕ** — СВОД ОТВЕРГАЛ «én látok azt» И НЕ СКАЗАЛ, ЧТО ГЛАГОЛ ПОМНИТ ПРЕДМЕТ. Замер 13.09 ПО ПЛАСТУ ВЕНГЕРСКОГО (2 269 строк): пар «неопределённое / определённое» 48 (восемь глаголов на шесть лиц), по 10 строк каждая — «látok val…
