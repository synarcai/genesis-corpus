# УКАЗАТЕЛЬ МИРОВ ПОКАЗА — 289 миров, 435214 строк
...
- **`tzone`** (72 строк; recompute, whole_only, exact_only)  
...
- **`angle`** (70 строк; recompute, whole_only, exact_only)  
