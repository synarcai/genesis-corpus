...
def main():
    ...
    # (голое утверждение подсадкой больше не годится: дом его не пишет и суду
    # оно не подсудно — см. tools/analogforms.py)
    подсадки = ("2 относится к 6, как 5 к чему? к 16.",
