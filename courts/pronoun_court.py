...
ОБРАЗЦЫ = (
    ...
    (rf"^{ИМЯ} (\S+) {Ч} {СЛ}\. {ИМЯ} (\S+) {Ч} {СЛ}\. {ИМЯ} (\S+) на {Ч} {СЛ} больше, чем (\S+): {Ч} − {Ч} = {Ч}\.$", _ru_два_акта),
    (rf"^{ИМЯ} (\S+) {Ч} {СЛ}\. {ИМЯ} (\S+) {Ч} {СЛ}\. на сколько {СЛ} больше (он|она) (\S+), чем (\S+)\? {Ч} − {Ч} = {Ч}\.$", _ru_два_акта_вопрос),
)
