...
# ОТКРЫТЫЕ СУТЬ СЕТИ, А НЕ РОДЫ ПИСЬМА, И ЭТО ОБЪЯВЛЕНО ЗДЕСЬ, А НЕ УГАДАНО МЕРОЙ.
#
# Каждый образец здесь есть ПРАВИЛО с одним освобождённым словом; страницы, которые он ловит,
# уже сосчитаны под своим правилом, а вопросной поверхности у сети нет и быть не может — сеть
# не пишут, ею ловят. Мера ширины, считавшая их родами, брала с этого суда 157 долгов за то,
# что он ловит ложь тщательнее прочих.
НЕ_РОДЫ = ("ОТКРЫТЫЕ",)


import closedworld  # noqa: E402
from closedworld import Слой  # noqa: E402 — the palata hands the world's name
# THE WORLD IS CLOSED: every honest line of «money_langs» is a shape of this court
# (measured 04.09), so a line of it this court does not recognise is a lie.
ЗАМКНУТЫЕ_МИРЫ = frozenset({"money_langs"})
