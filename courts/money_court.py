...
ОБРАЗЦЫ = (
    ...
    (rf"^{С} paid {Ч} cents for a {С} that costs {Ч} cents; \1 got {Ч} cents change: {Ч} − {Ч} = {Ч}\.$",
     lambda имя, paid, т, p, сд, o1, o2, сд2: имя in ИМЕНА_EN and (o1, o2) == (paid, p) and сд == сд2 == paid - p > 0),
    (rf"^{С} paid {Ч} cents for a {С} that costs {Ч} cents\. how much change did \1 get\? {Ч} − {Ч} = {Ч} cents\.$",
     lambda имя, paid, т, p, o1, o2, сд2: имя in ИМЕНА_EN and (o1, o2) == (paid, p) and сд2 == paid - p > 0),
    ...
    (rf"^([А-ЯЁ][а-яё]+) (заплатил|заплатила) {Ч} {СЛ}, а {СЛ} стоила {Ч} {СЛ}\. сколько сдачи (получил|получила) \1\? {Ч} − {Ч} = {Ч} {СЛ}\.$",
     lambda имя, г, paid, к1, т, p, к2, г2, o1, o2, сд2, к3: имя in ИМЕНА_RU and (г == "заплатила") == (г2 == "получила") == (ИМЕНА_RU[имя] == "f") and (o1, o2) == (paid, p) and сд2 == paid - p > 0 and _коп(paid, к1) and _коп(p, к2) and _коп(сд2, к3)),
