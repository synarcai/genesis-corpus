...
COURTS=("courts/arith_court.py" "courts/algo_court.py"
        ...
        "scripts/reproducible.py" "scripts/bash32_court.py" "scripts/empty_in_court.py" "scripts/lawfirst_court.py" "scripts/broken_law.py" "scripts/house_api.py" "scripts/json_hand.py" "scripts/suite_resume.py" "scripts/readme_court.py" "scripts/arith_debt.py" "scripts/twin_world.py" "scripts/house_selfcheck.py"
