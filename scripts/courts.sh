...
COURTS=("courts/arith_court.py" "courts/algo_court.py"
        ...
        "scripts/reproducible.py" "scripts/bash32_court.py" "scripts/empty_in_court.py" "scripts/lawfirst_court.py" "scripts/sign_intact.py" "scripts/property_named.py" "scripts/ladder_full.py" "scripts/name_crossed.py" "scripts/genre_measured.py" "scripts/second_copy.py" "scripts/margin_census.py" "scripts/reports_index.py" "tools/law_atlas.py" "tools/court_atlas.py" "scripts/permuted_fresh.py" "scripts/build_dated.py" "scripts/probe_present.py" "scripts/court_voice.py" "scripts/suite_guard.py" "scripts/forge_claim.py" "scripts/broken_law.py" "scripts/house_api.py" "scripts/json_hand.py" "scripts/suite_resume.py" "scripts/readme_court.py" "scripts/arith_debt.py" "scripts/twin_world.py" "scripts/orphan_world.py" "scripts/genus_shown.py" "scripts/oracle_named.py" "scripts/world_atlas.py" "scripts/trap_series.py" "scripts/house_selfcheck.py" "scripts/asked_uncounted.py"
        ...
        "courts/fipart_court.py" "courts/personplace_court.py" "courts/huobj_court.py"
