...
COURTS=("courts/arith_court.py" "courts/algo_court.py"
        ...
        "courts/disj_court.py" "courts/indu_court.py" "courts/houseshows_court.py" "courts/article_court.py" "courts/rowframe_court.py" "courts/opchoice_court.py" "courts/chance_court.py" "courts/lever_court.py" "courts/zerodiv_court.py" "courts/bound_court.py" "courts/prec_court.py" "courts/estim_court.py" "courts/analog_court.py" "courts/reply_court.py"
