...
COURTS=("courts/arith_court.py" "courts/algo_court.py"
        ...
        "scripts/ask_reach.py" "scripts/band_reach.py" "scripts/biblio_reach.py" "courts/ruverbs_court.py" "courts/script_court.py" "scripts/word_mutants.py" "scripts/verdict_cover.py" "scripts/sentence_cover.py" "scripts/shelf_court.py" "scripts/ask_width.py" "courts/notationvar_court.py"
        ...
        "scripts/prefix_traps.py" "scripts/sign_traps.py"
