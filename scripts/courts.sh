...
COURTS=("courts/arith_court.py" "courts/algo_court.py"
        ...
        # СЛОВО ПЕРЕД ЛИЦОМ: «does Ben hold» → «does Be hold» проходило палату истиной — внутри
        # предложения обрезок имени был ничей. За строгим словом свод ставил лишь объявленное.
        "courts/beforeperson_court.py"
        ...
        # РЫНОК СЛОВА ПЕРЕД ЛИЦОМ — пятая полка того же рода: какие классы свод ставит за
        # словом, после которого стоит лицо. Краснеет, когда свод ушёл вперёд покупки.
        "scripts/beforeperson_market.py"
