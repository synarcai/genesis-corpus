...
COURTS=("courts/arith_court.py" "courts/algo_court.py"
        ...
        "scripts/reproducible.py" "scripts/bash32_court.py" "scripts/empty_in_court.py" "scripts/lawfirst_court.py" "scripts/broken_law.py" "scripts/house_selfcheck.py"
