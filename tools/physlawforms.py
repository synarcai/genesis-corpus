...
# родов). «Сохранение» есть один закон на многих числах: было столько-то, стало столько-то, сумма
# не изменилась. Прочие роды НЕ объявлены: «размерности» и «законы» говорят словами и чисел
# при них нет, а «давление» и «волна» перебирают ЕДИНИЦЫ вместе с числами, и очертаний у них
# много само собою.
#
#     УПРАЖНЕНИЕ ТАМ, ГДЕ ЧИСЛА СУТЬ МАТЕРИАЛ, А МЫСЛЬ ОДНА.
ОЧЕРТАНИЕ_ПО_ПРИРОДЕ = ("сохранение",)
