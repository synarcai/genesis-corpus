...
ШЕСТЬ ФОРМ, И ПОСЛЕДНИЕ ТРИ ВАЖНЕЕ ПЕРВЫХ ТРЁХ:
  ...
  КОНТРАПОЗИЦИЯ  «„если число делится на 4, оно делится на 2“ и „если число не делится
                 на 2, оно не делится на 4“ суть ОДНО высказывание в двух видах.»
...
КЛЕТОК ОБЪЯВЛЕНО ДЕВЯТЬ, А ФОРМ ШЕСТЬ: `ФОРМЫ` держит и вопросные поверхности трёх
верных ходов, ибо они суть отдельные рамки, а не украшение тех же.
