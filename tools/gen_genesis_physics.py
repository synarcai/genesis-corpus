...
def pass_shows(pass_i):
    ...
    for i in range(10):
        ...
        out.append("1 kilometre = 1000 metres.")
        out.append("1 metre = 100 centimetres.")
        out.append("1 metre = 1000 millimetres.")
        out.append("1 километр = 1000 метров.")
        out.append("1 метр = 100 сантиметров.")
