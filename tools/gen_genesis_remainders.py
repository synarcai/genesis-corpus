...
# ДОЛГ РУССКОЙ СТОРОНЫ ЭТОГО РОДА НАЗВАН (15.09). Едва дом объявил язык при странице, мера
# щербатости показала: «17 apples shared among 5 kids leaves 2 left over» сказано только
# по-английски. Русский говорит это не хуже — «17 яблок разделить между 5 детьми: 2 лишних», —
# но говорить ему НЕЧЕМ: вещи и носители берутся из общих АНГЛИЙСКИХ списков `ITEMS` и
# `ANIMATE`, и русская сторона требует своего списка со счётными формами, а не перевода рамки.
#
