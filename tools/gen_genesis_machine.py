...
import rugram  # noqa: E402 — счётная форма объявлена пакетом
...
#
# И ТАБЛИЦА, СТОЯВШАЯ ЗДЕСЬ ДО 12.09, БЫЛА ИМЕННО ПЕРЕПИСЫВАНИЕМ: она объявляла
# «бит» третьей формой там, где пакет говорит «битов», — и восемь строк этого мира
# расходились с тремястами двадцатью мира `compsci`, читавшего пакет честно.
#
