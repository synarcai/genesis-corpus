...
# ЯЗЫКОВОЙ ДОЛГ ДОМА НАЗВАН (15.09): три рода звучат только по-английски — «запись в
# основании → десятичное число», «исключающее ИЛИ на той же паре» и «сдвиг вправо: дело
# обратное». Русские близнецы их не кованы, тогда как прямые дела (число → запись, И, ИЛИ,
# сдвиг влево) говорят обоими языками. Ничего, кроме рамки речи, тут и не разнится: числа,
# основания и вердикты у обоих языков одни — оттого долг этот дёшев и назван, чтобы быть
# взятым, а не чтобы о нём забыли.
