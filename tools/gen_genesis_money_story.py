...
def язык_группа(шаг, язык):
    ...
    # СЕМЕЙСТВО СТРАНИЦЫ ЕСТЬ ЕЁ РОД, И ОНО СТОИТ ВТОРЫМ ДОВОДОМ КАЖДОГО ЗОВА (14.09).
    # Дом `moneystory` объявляет их рядом (`СЕМЕЙСТВА`), кузница называет поимённо — и
    # своду об этом не говорил никто.
...
ЗАЧЕМ_РОДА = {
    "акт": "прибавка или убыль суммы: рубли и копейки складываются своими разрядами",
    "покупка": "вещь куплена, и сдача сосчитана",
    "имеет": "сколько денег в руках — сумма названа без действия над ней",
    "ставка": "столько-то в день столько-то дней поверх начального: a + b × n",
    "покупка1": "n одинаковых вещей по цене P: одно умножение",
    "покупка2": "две вещи со своими ценами и числами: два умножения и сумма",
    "покупка3": "три вещи со своими ценами: цепь в пять шагов — три произведения и две "
                "суммы",
}
...
def _самопроверка_дома():
    ...
    вне = {р for _с, р, _я in перебор_страниц(0)} - set(РОДЫ)
