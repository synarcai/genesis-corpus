...
ЯЗЫКИ = {
    ...
    "ru": dict(
        ...
        больше_теперь="у {Xр} на {d} {Тd} {З}, чем {У} число {Тм} у {Yр}. у {Yр} {n} {Тn}. сколько {Тм} у {Xр} теперь?",
        обратно_теперь="у {Xр} на {d} {Тd} {З}, чем {У} число {Тм} у {Yр}. у {Xр} {m} {Тm}. сколько {Тм} у {Yр} теперь?",
        знаки={"−": "меньше", "+": "больше"},
