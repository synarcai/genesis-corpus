...
# ВОПРОС СТОИ́Т СВОЕЙ ГРУППОЙ: он не третий случай знака, а ТОТ ЖЕ случай, поставленный
# иначе. Смешать его с утверждением значило бы дать читателю ответ РЯДОМ с вопросом.
ГРУППЫ = (("минус на плюс", "минус на минус"), ("деление знаком", "лестница"), ("спрошенное",))
