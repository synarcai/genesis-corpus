...
# языка («с» и «вс» суть связки, гнущиеся по числителю). Взять таблицу целиком значило бы напечатать
...
_РОДЫ_В_ЯЗЫКЕ = ("утв", "воп")
_ИМЯ_РОДА = {"утв": "доля с леджером деления и умножения",
              "воп": "вопрос о доле, отвечаемый им же"}
