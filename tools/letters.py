...
# ПАСПОРТ ИДЁТ ЗА ПЕРЕЕЗДОМ, А НЕ ЗА ПАМЯТЬЮ (16.09): чтение букв переехало из кузницы
# `gen_genesis_md_latex` в дом `markupforms`, кузница стала звать дом, — и паспорт остался
# называть кузницу и молчать о доме. Обе половины разлада суть одна правка, не сделанная
# в день переезда.
#
#     ПЕРЕЕЗД ИМЕНИ ЕСТЬ ПРАВКА ВСЕХ, КТО ЕГО НАЗЫВАЕТ, — и паспорта в том числе.
ЧИТАЮТ = ("markupforms", "gen_genesis_letters", "letters_court", "holdout_key")
...
ЯЗЫКИ = {
    "ru": dict(слова=("кот", "вода", "школа", "солнце", "учитель", "карандаш", "велосипед", "библиотека"),
    ...
    "en": dict(слова=("cat", "hand", "table", "window", "teacher", "computer", "telephone", "strawberry"),
    ...
    "de": dict(слова=("Uhr", "Hand", "Katze", "Garten", "Fenster", "Computer", "Bleistift", "Kinderbuch"),
    ...
    "fr": dict(слова=("eau", "main", "table", "maison", "fenêtre", "chocolat", "téléphone", "ordinateur"),
    ...
    "es": dict(слова=("sol", "mano", "perro", "camisa", "ventana", "elefante", "chocolate", "biblioteca"),
    ...
    "it": dict(слова=("oro", "mano", "penna", "tavolo", "bambino", "finestra", "cucchiaio", "biblioteca"),
    ...
    "pt": dict(слова=("sol", "mesa", "carta", "janela", "cadeira", "telefone", "chocolate", "computador"),
    ...
    "nl": dict(слова=("zon", "hand", "tafel", "school", "venster", "computer", "aardappel", "boekenkast"),
    ...
    "pl": dict(слова=("kot", "woda", "chleb", "słońce", "telefon", "komputer", "czekolada", "biblioteka"),
