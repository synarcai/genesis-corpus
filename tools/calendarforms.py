#!/usr/bin/env python3
"""ДОМ КАЛЕНДАРЯ — круговая арифметика в её прикладном роде.

Ни дня недели, ни месяца не стояло в своде нигде. Календарь есть круговая арифметика,
и круг этот замыкается не в числе, а в ИМЕНИ: после воскресенья идёт понедельник.
...
ЗАЧЕМ_РОДА = {
    "дни": "день недели и его имя",
    "соседи": "что идёт после и что перед",
    "вопросы": "тот же круг, спрошенный вопросом",
    "месяцы": "месяц и его длина",
    "годом": "счёт годом",
    "колесо_парой": "круг, пройденный парой шагов",
}
