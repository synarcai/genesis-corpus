...
# ЯЗЫКОВОЙ ДОЛГ ДОМА НАЗВАН (15.09): род «суммы» — сложение десятичной записи денег («2.05
# dollars + 1.05 dollars = 3.10 dollars: 205 + 105 = 310 cents») — звучит только
# по-английски. Русская сторона его НЕ ЕСТЬ перевод: у рубля десятичная запись пишется
# запятою, а счётная форма при дробном числе стои́т в родительном единственного («2,05
# рубля», а не «2,05 рублей»), и это отдельный урок русской грамматики, а не рамка.
#
#     ПЕРЕВОД РАМКИ И ВТОРОЙ УРОК — РАЗНЫЕ РАБОТЫ, И ВТОРАЯ ДОРОЖЕ ПЕРВОЙ. Оттого долг
#     назван, а не закрыт наспех: дом, написавший «2,05 рублей», учил бы неверному.
