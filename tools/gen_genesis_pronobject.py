#!/usr/bin/env python3
"""GENESIS layer: TRANSFER WITH A PRONOUN OBJECT — see tools/pronobject.py for the law.
...
ЦЕЛЬ = "datasets/genesis_pronobject.txt"


def язык_группа(шаг, язык):
    свои = [с for с, (л, _ф, _л) in F.ПОКАЗЫ.items() if л == язык]
