...
# ДОЛГ РУССКОЙ СТОРОНЫ ДВУХ РОДОВ НАЗВАН (15.09). Едва дом объявил язык при странице, мера
# щербатости показала: «целое из двух счётов» и «та же доля, но об ушедшем» сказаны только
# по-английски, а весь дом пишет 252 английские страницы против 49 русских — впятеро.
#
