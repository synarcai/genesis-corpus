#!/usr/bin/env python3
"""ДОМ ВОПРОШАНИЯ (inquiry_de_fr) — шесть ступеней определения на двух языках.

Мир `inquiry_de_fr` стоял без объявленного рода: шесть родов лежали в кузнице кортежем
