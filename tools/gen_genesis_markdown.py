...
# ЦЕЛЬ ОБЪЯВЛЕНА СТРОКОЙ ВЕРХНЕГО УРОВНЯ, А НЕ ВПИСАНА В ЗОВ (13.09). Указатель родов узнаёт
# мир дома по ВВОЗУ кузницы и её объявленной цели; путь, живущий лишь внутри `emit_grouped`,
# оставляет дом БЕЗ МИРА — и сайдкар не может развести спор двух домов местом строки.
#
#     ПУТЬ, СКАЗАННЫЙ ТОЛЬКО В ЗОВЕ, ЕСТЬ ПУТЬ, О КОТОРОМ НЕ ОБЪЯВЛЕНО.
ЦЕЛЬ = "datasets/genesis_markdown.txt"
