...
# ВОПРОС СТОИ́Т СВОЕЙ ГРУППОЙ: он не третий случай сложения, а ТОТ ЖЕ случай,
# поставленный иначе. Смешать его с утверждением значило бы дать читателю ответ
# РЯДОМ с вопросом — а вопрос тем и ценен, что ответ на него надо искать.
ГРУППЫ = (("чёт и чёт", "нечёт и нечёт", "чёт и нечёт"), ("множитель",), ("спрошенное",))
