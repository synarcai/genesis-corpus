...
ОТДАЛ = ((7, 3), (11, 4), (9, 6), (13, 5), (8, 7), (15, 9), (6, 2), (12, 8),
         (14, 5), (16, 9), (10, 3), (17, 6), (19, 8), (21, 4), (18, 7), (23, 9))
КУПИЛ = ((11, 4), (14, 6), (9, 3), (17, 8), (12, 5), (20, 9), (10, 2), (16, 7),
         (13, 4), (15, 6), (18, 5), (19, 9), (21, 3), (22, 8), (24, 7), (25, 6))
ПОТРАТИЛ = ((76, 25), (48, 17), (95, 38), (63, 29), (52, 14), (87, 46), (39, 21), (71, 33),
            (44, 15), (58, 23), (66, 31), (74, 39), (82, 47), (35, 12), (59, 26), (91, 49))
...
def рамка(язык, форма, i, хвост):
    ...
    вопрос = р["вопрос_вещь"].replace("{КСК}", _кс_k(язык, i)).replace("{МН}", мн).replace("{ХВОСТ}", х)
    if форма == "отдал":
...
def _судить_образцом(строка):
    ...
    #
    # Замерено: закон судит все 3600 показов дома верно и без набора — выход был
