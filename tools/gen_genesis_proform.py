#!/usr/bin/env python3
"""GENESIS layer: THE PRO-FORM OF THE GOODS — see tools/proform.py for the law.
...
ЦЕЛЬ = "datasets/genesis_proform.txt"


def язык_группа(шаг, язык):
    свои = [с for с, (л, _ф) in F.ПОКАЗЫ.items() if л == язык]
