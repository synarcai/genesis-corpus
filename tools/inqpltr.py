...
def исп_делимость(шаг):
    ...
    """
    # УЗОР ЭТОЙ ФУНКЦИИ НЕ РОВЕН, И ЭТО СКАЗАНО ВСЛУХ: на один польский показ идут ДВЕ
    # турецкие поверхности, и сбор метит строки по объявленному узору, а не пополам.
    вон = bilang.Узором(("pl", "tr", "tr"))
