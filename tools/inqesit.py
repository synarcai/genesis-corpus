#!/usr/bin/env python3
"""ДОМ ВОПРОШАНИЯ (inquiry_es_it) — шесть ступеней определения на двух языках.

Мир `inquiry_es_it` стоял без объявленного рода: шесть родов лежали в кузнице кортежем
