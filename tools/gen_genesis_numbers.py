...
def сравнения(шаг):
    ...
    for i in range(24):
        ...
        да_en = f"yes: {a} and {r} are congruent modulo {m}: {a} mod {m} = {r}, {r} mod {m} = {r}."
        да_ru = f"да: {a} и {r} сравнимы по модулю {m}: {a} по модулю {m} равно {r}, {r} по модулю {m} равно {r}."
        вон.append(спросить("congruent", да_en, a=a, b=r, m=m))
        вон.append(спросить("сравнимы", да_ru, a=a, b=r, m=m))
