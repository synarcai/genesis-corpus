...
def прямоугольники(шаг):
    ...
    for i in range(24):
        ...
        утв_en = f"{en} has area {a * b} and perimeter {2 * (a + b)}."
        утв_ru = (f"{ru} имеет площадь {a * b} "
                  f"и периметр {2 * (a + b)}.")
        вон.append(утв_en)
        вон.append(утв_ru)
...
def квадраты(шаг):
    ...
    for i in range(16):
        ...
        утв_en = f"{en} has area {a * a} and perimeter {4 * a}."
        утв_ru = f"{ru} имеет площадь {a * a} и периметр {4 * a}."
        вон.append(утв_en)
        вон.append(утв_ru)
        вон.append(спросить("area", en, утв_en))
        вон.append(спросить("площадь", ru_род, утв_ru))
...
def треугольники(шаг):
    ...
    for i in range(20):
        ...
        утв_en = f"{en} has area {b * h // 2}."
        утв_ru = f"{ru} имеет площадь {b * h // 2}."
        вон.append(утв_en)
        вон.append(утв_ru)
        вон.append(спросить("area", en, утв_en))
        вон.append(спросить("площадь", ru_род, утв_ru))
...
def пифагор(шаг):
    ...
    for a, b, c in ТРОЙКИ:
        ...
        утв_en = f"{en} has hypotenuse {c}."
        утв_ru = f"{ru} имеет гипотенузу {c}."
        вон.append(утв_en)
        вон.append(утв_ru)
...
def тела(шаг):
    ...
    for i in range(20):
        ...
        утв_к_en = (f"{en_к} has volume {a * b * c} and surface "
                    f"{2 * (a * b + b * c + a * c)}.")
        утв_к_ru = (f"{ru_к} имеет объём {a * b * c} и поверхность "
                    f"{2 * (a * b + b * c + a * c)}.")
        en_куб, ru_куб = f"a cube with edge {a}", f"куб с ребром {a}"
        ru_куб_род = f"куба с ребром {a}"
        утв_куб_en = f"{en_куб} has volume {a ** 3}."
        утв_куб_ru = f"{ru_куб} имеет объём {a ** 3}."
        вон.append(утв_к_en)
        вон.append(утв_к_ru)
