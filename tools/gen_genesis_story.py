...
NAMES_EN_HOUSE = ["mary", "peter", "vera", "nick",
            "ann", "dima", "lena", "yuri"]
...
NAMES_EN = [_ПО_СТРОЧНОМУ.get(и.lower(), и) for и in NAMES_EN_HOUSE]
assert set(NAMES_EN) <= _ИМЕНА_ПАКЕТА, "имя не объявлено пакетом en"
